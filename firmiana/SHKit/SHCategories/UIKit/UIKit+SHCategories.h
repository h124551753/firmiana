...
#ifndef UIKit_SHCategories_h
#define UIKit_SHCategories_h
...
//MARK: UITabBarController+SHPush
#import "UITabBarController+SHPush.h"           // UITabBarController 当前VC Push
