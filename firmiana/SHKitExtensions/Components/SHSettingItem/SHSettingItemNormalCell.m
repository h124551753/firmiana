...
#import "SHSettingItemNormalCell.h"

@interface SHSettingItemNormalCell ()
...
@implementation SHSettingItemNormalCell
...
- (void)setItem:(SHSettingItem *)item
{
    ...
    if (item.rightImagePath) {
        ...
        [self.rightImageView tt_setImageWithURL:SHURL(item.rightImageURL) placeholderImage:[UIImage imageNamed:DEFAULT_AVATAR_PATH]];
    }
    else {
