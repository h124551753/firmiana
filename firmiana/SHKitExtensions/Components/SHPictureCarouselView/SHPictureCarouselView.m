...
#import "SHPictureCarouselView.h"
#import "SHPictureCarouselViewCell.h"
#import "UIScrollView+Pages.h"

@interface SHPictureCarouselView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation SHPictureCarouselView
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [self.collectionView registerClass:[SHPictureCarouselViewCell class] forCellWithReuseIdentifier:@"SHPictureCarouselViewCell"];
    }
    return self;
}
...
{
    id<SHPictureCarouselProtocol> model = self.data[indexPath.row];
    SHPictureCarouselViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"SHPictureCarouselViewCell" forIndexPath:indexPath];
    [cell setModel:model];
    return cell;
}
